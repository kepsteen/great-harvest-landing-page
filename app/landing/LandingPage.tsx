					...
					<div className="">
						<div className="lg:pt-30 my-auto lg:grid grid-cols-2">
							<div className="mx-auto lg:mx-0 w-full  flex flex-col gap-y-10 md:gap-y-15">
								...
								<div className="w-full px-5 md:px-0 md:px-0 lg:pl-5 lg:pr-0">
									<div className="px-7 py-2.5 md:py-5 bg-lightBeigeOp text-brandBlue font-bold text-xl md:mx-[80px]">
										<p>
											We&apos;re looking for
							...
							<div className="bg-translucent-blue mt-7.5 mx-5 md:mx-[80px] rounded-xl">
