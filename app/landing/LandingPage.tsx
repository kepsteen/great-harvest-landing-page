...
export default function LandingPage() {
  return (
    <>
      <div className="relative h-screen w-full bg-[url('/images/mobile-harvest-landing-image.png')] bg-[300%_auto] bg-[49%_55%] flex" aria-hidden="true">
        <Navbar />
        <div className="mx-auto my-auto w-full flex flex-col gap-y-26">
          <div className="flex flex-col text-center">
            <h1 className="text-[74px] text-cream text-shadow leading-20">Harvest</h1>
            <h1 className="text-[53px] text-logoOrange text-shadow">Opportunity</h1>
            <h1 className="text-[74px] text-cream text-shadow leading-20">Today</h1>
          </div>
          <div className="w-full px-1">
            <div className="px-3 py-1 rounded-xl bg-lightBeigeOp text-brandBlue font-bold text-xl">
