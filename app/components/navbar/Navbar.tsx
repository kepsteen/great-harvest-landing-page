...
export default function Navbar() {
	...
	return (
		<>
			<nav
				className={`fixed top-0 left-0 w-full px-5 md:px-6 lg:px-17.5 py-5 z-50 transition-all duration-300 ease-in-out ${isMenuOpened || isScrolled ? " py-4 bg-cream" : "bg-transparent py-5"}
			`}
				role="navigation"
