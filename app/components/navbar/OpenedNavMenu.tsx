...
export default function OpenedNavMenu({
	...
	return (
		<>
			<div
				id="mobile-nav-menu"
				className="pt-5 bg-logo-orange rounded-b-xl text-white shadow-[0px_4px_4px_0px_#00000040] max-w-[400px] max-h[530px]"
			>
				...
				<div className="py-5 text-center">
					<button
						className="bg-white py-4 px-5 rounded-full text-black text-[20px] cursor-pointer hover:bg-gray-200"
