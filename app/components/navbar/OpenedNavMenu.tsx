    ...
    <div id="mobile-nav-menu" className="pt-5 bg-cream">
      ...
      <div>
        <ul className="flex flex-col bg-tan text-center mt-5">
          ...
          <li className="py-4 border-b-[1px] text-[20px]">
            <a href="#whyGreatHarvest" onClick={() => setIsMenuOpen(!isMenuOpen)}>
            Why Great Harvest?
            </a>
          </li>
          <li className="py-4 border-b-[1px] text-[20px]">
            <a href="#corporateSupport" onClick={() => setIsMenuOpen(!isMenuOpen)}>
            Corporate Support
            </a>
          </li>
          <li className="py-4 border-b-[1px] text-[20px]">
            <a href="#testimonials" onClick={() => setIsMenuOpen(!isMenuOpen)}>
            Franchise Testimonials
            </a>
          </li>
          <li className="py-4 border-b-[1px] text-[20px]">
            <a href="#theProcess" onClick={() => setIsMenuOpen(!isMenuOpen)}>
            The Process
            </a>
          </li>
          <li className="py-4 border-b-[1px] text-[20px]">
            <a href="#faq" onClick={() => setIsMenuOpen(!isMenuOpen)}>
            FAQs
            </a>
          </li>
        </ul>
