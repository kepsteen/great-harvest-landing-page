		...
		>
			...
			<div className="flex flex-col w-full max-w-[632px] mx-auto gap-[20px]">
				{faqs.map((faq) => (
					<details
						key={faq.question}
						className="bg-white rounded-lg border-[0.5px] border-charcoal-gray p-[10px] open:border-logo-orange shadow-[4px_4px_4px_0px_#FFFFFF40] open:shadow-[4px_4px_4px_0px_#b43c24] open:border-[1.5px]"
						name="faq"
					>
