  ...
  return (
    <>
      <section className="bg-[url(https://imgc.allpostersimages.com/img/posters/karandaev-wood-texture-cutting-board-background_u-l-q1052q40.jpg?artHeight=550&artPerspective=n&artWidth=550&background=ffffff)] pt-10 pb-5">
        <div>
          <h1 className="font-normal text-[48px] text-center py-4">Backed by our Franchisees</h1>
          <div className="bg-white rounded-xl mx-5 px-6 pt-6 md:pb-6 md:grid md:grid-cols-2 md:w-[80%] md:mx-auto">
            <div className="mb-2.5 md:order-2 lg:my-auto">
              ...
              <div className="py-2.5 md:pb-0">
                <h2 className="text-end md:text-start md:pl-5">Elise, Katie, & Kodiak Smith</h2>
                <p className="text-end md:text-start md:pl-5">Harvesting in<br />Northwest, Indiana</p>
              </div>
            </div>
