...
export default function TestimonialSection() {
  return (
    <>
      <section className="bg-[url(https://imgc.allpostersimages.com/img/posters/karandaev-wood-texture-cutting-board-background_u-l-q1052q40.jpg?artHeight=550&artPerspective=n&artWidth=550&background=ffffff)] pt-10 pb-5 md:py-12.5">
        <div>
          <h1 className="font-bold text-[48px] text-center py-4 md:pt-0">Backed by our Franchisees</h1>
          <div className="bg-white rounded-xl mx-5 px-6 pt-6 md:pb-6 md:grid md:grid-cols-2 md:w-[80%] md:mx-auto">
            ...
            <div className="pb-4 md:pb-0 md:h-full md:order-1 md:flex md:items-center">
              <Image className="lg:w-full max-w-[475px] rounded-full mx-auto" src="/images/franchisees-owner.png" width={290} height={298} alt="Three of Great Harvest franchise owner in Great Harvest apparel" />
            </div>
          </div>
        </div>
      </section>
