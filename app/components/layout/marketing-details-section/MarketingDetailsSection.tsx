          ...
          <div className="pb-10">
            ...
            {MarketingCardData.map((marketingCard, index) => (
              <li key={index} className='flex flex-col pt-12 px-2.5 lg:pt-17.5'>
                ...
                <h1 className="text-[20px] px-10 md:px-5 lg:px-10 py-4 text-center md:basis-[150px] lg:basis-[100px]">{marketingCard.title}</h1>
                <div className="pl-2.5">
                  <p className="text-[18px] grow">{marketingCard.passage}</p>
                </div>
              </li>
            ))}
            </ul>
